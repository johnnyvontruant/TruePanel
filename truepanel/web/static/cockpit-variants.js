...
function installStyle(){
    ...
    style.textContent=`
.cockpit-layout-switcher{max-width:1400px;margin:.75rem auto 0;padding:0 1.5rem;display:flex;align-items:center;gap:.55rem;color:var(--muted);font-size:.7rem}.cockpit-layout-switcher strong{margin-right:.2rem;color:var(--text);font-size:.68rem;letter-spacing:.1em;text-transform:uppercase}.cockpit-layout-switcher button{padding:.42rem .65rem;font-size:.68rem}.cockpit-layout-switcher button.active{border-color:var(--accent);background:var(--accent);color:var(--text)}.cockpit-preview-note{margin-left:auto;font-size:.65rem;letter-spacing:.06em;text-transform:uppercase}
.lcd-screen.cockpit-matrix-active{padding:.95rem 1rem}.lcd-screen.cockpit-matrix-active>.lcd-row{position:absolute!important;width:1px!important;height:1px!important;margin:-1px!important;padding:0!important;overflow:hidden!important;clip:rect(0,0,0,0)!important;white-space:nowrap!important;border:0!important}.cockpit-lcd-matrix{position:relative;z-index:2;display:grid;gap:.42rem;width:100%;margin:0 auto}.cockpit-matrix-row{display:grid;grid-template-columns:repeat(16,minmax(0,1fr));gap:clamp(2px,.32vw,5px);align-items:center}.cockpit-matrix-glyph{display:grid;grid-template-columns:repeat(5,1fr);grid-template-rows:repeat(7,1fr);gap:1px;aspect-ratio:5/7;min-width:0}.cockpit-matrix-dot{display:block;border-radius:18%;background:rgba(255,255,255,.08)}.cockpit-matrix-dot.on{background:#f8fbff}.cockpit-bay-strip{max-width:920px;margin:.7rem auto 0;padding:.65rem .9rem;border:1px solid color-mix(in srgb,var(--edge) 18%,transparent);border-radius:10px;background:color-mix(in srgb,var(--panel-solid) 50%,transparent);backdrop-filter:blur(18px) saturate(180%);-webkit-backdrop-filter:blur(18px) saturate(180%)}.cockpit-bay-head{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:.5rem}.cockpit-bay-title{color:var(--muted);font-size:.62rem;font-weight:850;letter-spacing:.13em;text-transform:uppercase}.cockpit-bay-source{color:var(--muted);font-size:.58rem}.cockpit-bays{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:.55rem}.cockpit-bay{display:grid;justify-items:center;gap:.28rem;min-width:0}.cockpit-bay-led{width:.78rem;height:.78rem;border:1px solid color-mix(in srgb,var(--text) 16%,transparent);border-radius:50%;background:var(--panel-solid);box-shadow:inset 0 0 4px color-mix(in srgb,var(--panel-solid) 80%,transparent)}.cockpit-bay-led.online{border-color:color-mix(in srgb,var(--good) 70%,transparent);background:var(--good);box-shadow:0 0 8px color-mix(in srgb,var(--good) 45%,transparent)}.cockpit-bay-led.attention,.cockpit-bay-led.present{border-color:color-mix(in srgb,var(--warn) 72%,transparent);background:var(--warn);box-shadow:0 0 8px color-mix(in srgb,var(--warn) 35%,transparent)}.cockpit-bay-led.fault,.cockpit-bay-led.missing,.cockpit-bay-led.identify{border-color:color-mix(in srgb,var(--bad) 80%,transparent);background:var(--bad);box-shadow:0 0 9px color-mix(in srgb,var(--bad) 50%,transparent)}.cockpit-bay-number{color:var(--muted);font-size:.6rem;font-variant-numeric:tabular-nums}.cockpit-bay-state{max-width:100%;overflow:hidden;color:var(--muted);font-size:.52rem;text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap}
