...
:root{--gc-glass-specular:rgba(255,255,255,.34);--gc-glass-side:rgba(255,255,255,.10);--gc-glass-rim:rgba(112,101,149,.13);--gc-glass-lower:rgba(42,45,60,.12);--gc-glass-shadow:rgba(31,35,48,.14)}
:root[data-theme="dark"]{--gc-glass-specular:rgba(255,255,255,.14);--gc-glass-side:rgba(255,255,255,.045);--gc-glass-rim:rgba(112,94,160,.085);--gc-glass-lower:rgba(0,0,0,.24);--gc-glass-shadow:rgba(0,0,0,.26)}
...
body.cockpit-polished .card::after,body.cockpit-polished .cockpit-drawer::after,body.cockpit-polished .cockpit-maintenance-drawer::after{content:"";position:absolute;inset:0;border-radius:inherit;pointer-events:none;z-index:0;background:radial-gradient(120% 86% at 0% 0%,var(--gc-glass-specular),transparent 42%),linear-gradient(145deg,var(--gc-glass-side) 0,transparent 24%,transparent 76%,var(--gc-glass-rim) 100%);box-shadow:inset 0 1px 0 var(--gc-glass-specular),inset 1px 0 0 var(--gc-glass-side),inset 0 -1px 0 var(--gc-glass-lower),0 12px 28px var(--gc-glass-shadow)}
...
@media(prefers-color-scheme:dark){:root:not([data-theme="light"]){--gc-glass-specular:rgba(255,255,255,.14);--gc-glass-side:rgba(255,255,255,.045);--gc-glass-rim:rgba(112,94,160,.085);--gc-glass-lower:rgba(0,0,0,.24);--gc-glass-shadow:rgba(0,0,0,.26)}}
