...
function install(){
    ...
    style.textContent=`
#pathfinderRecoveryDeck{margin:1rem 0;padding:1rem;border:1px solid rgba(57,167,255,.5);border-radius:12px;background:rgba(8,19,29,.72)}#pathfinderRecoveryDeck[hidden]{display:none}.pf-head{display:flex;justify-content:space-between;gap:1rem;align-items:flex-start}.pf-head h3{margin:.25rem 0;font-size:1.08rem}.pf-kicker{color:var(--accent);font-size:.64rem;font-weight:900;letter-spacing:.11em;text-transform:uppercase}.pf-code{color:var(--muted);font-size:.72rem}.pf-authority{padding:.35rem .55rem;border:1px solid var(--edge);border-radius:999px;color:var(--muted);font-size:.62rem;font-weight:850;white-space:nowrap}.pf-progress{display:flex;gap:.4rem;margin:1rem 0;overflow-x:auto;padding-bottom:.25rem}.pf-stage{display:flex;align-items:center;gap:.38rem;min-width:108px;padding:.45rem .55rem;border:1px solid var(--edge);border-radius:8px;color:var(--muted);font-size:.68rem}.pf-stage span{display:grid;place-items:center;width:20px;height:20px;border:1px solid currentColor;border-radius:50%;font-weight:900}.pf-stage.active{color:var(--warn);border-color:rgba(255,200,87,.5);background:rgba(76,52,11,.2)}.pf-stage.done{color:var(--good);border-color:rgba(80,205,137,.32)}.pf-grid{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:1rem}.pf-grid section{padding:.75rem;border:1px solid rgba(143,164,184,.14);border-radius:9px}.pf-grid h4{margin:0 0 .5rem;color:var(--muted);font-size:.68rem;letter-spacing:.1em;text-transform:uppercase}.pf-grid p{margin:.2rem 0 .7rem;color:var(--muted);font-size:.8rem;line-height:1.45}.pf-verification{display:inline-block;padding:.3rem .45rem;border-radius:6px;font-size:.62rem;font-weight:900}.pf-verification.pending{color:var(--warn);border:1px solid rgba(255,200,87,.35)}.pf-verification.passed{color:var(--good);border:1px solid rgba(80,205,137,.35)}.pf-timeline{display:grid;gap:.35rem}.pf-timeline-row{display:grid;grid-template-columns:62px 1fr auto;gap:.45rem;align-items:center;font-size:.7rem}.pf-timeline-row span{color:var(--muted);font-size:.58rem;font-weight:900}.pf-timeline-row small{color:var(--muted)}.pf-empty{color:var(--muted);font-size:.72rem}.pf-actions{display:flex;flex-wrap:wrap;gap:.5rem;margin-top:1rem}.pf-action{padding:.55rem .75rem;border:1px solid rgba(57,167,255,.5);border-radius:8px;background:rgba(57,167,255,.12);color:var(--text);font:inherit;font-size:.75rem;font-weight:800;cursor:pointer}.pf-action.secondary{border-color:var(--edge);background:transparent;color:var(--muted)}.pf-action:disabled{opacity:.45;cursor:not-allowed}.pf-safety{margin:.8rem 0 0;color:var(--muted);font-size:.68rem;line-height:1.45}@media(max-width:760px){.pf-head{display:block}.pf-authority{display:inline-block;margin-top:.55rem}.pf-grid{grid-template-columns:1fr}.pf-progress{margin-right:-.25rem}.pf-stage{min-width:96px}.pf-actions{display:grid;grid-template-columns:1fr}.pf-action{width:100%}.pf-timeline-row{grid-template-columns:58px 1fr}.pf-timeline-row small{grid-column:2}}
`;
