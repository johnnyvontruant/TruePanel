...
function install(){
    ...
    style.textContent=`
.ll-actions{margin:.75rem 0;padding:.75rem;border:1px solid color-mix(in srgb,var(--accent) 28%,transparent);border-radius:10px;background:color-mix(in srgb,var(--panel-solid) 28%,transparent);backdrop-filter:blur(18px) saturate(180%);-webkit-backdrop-filter:blur(18px) saturate(180%)}.ll-actions h4{margin:0 0 .55rem;color:var(--muted);font-size:.67rem;letter-spacing:.1em;text-transform:uppercase}.ll-action-row{display:flex;justify-content:space-between;gap:1rem;align-items:center;padding:.55rem 0;border-top:1px solid color-mix(in srgb,var(--edge) 10%,transparent)}.ll-action-row:first-of-type{border-top:0}.ll-action-row strong{display:block;font-size:.76rem}.ll-action-row span{display:block;margin-top:.15rem;color:var(--muted);font-size:.68rem;line-height:1.35}.ll-action-buttons{display:flex;gap:.45rem;align-items:center;justify-content:flex-end;flex-wrap:wrap}.ll-ack-backup,.ll-identify-bay{border:1px solid color-mix(in srgb,var(--accent) 42%,transparent);border-radius:8px;padding:.48rem .65rem;background:color-mix(in srgb,var(--accent) 28%,transparent);color:var(--accent);font-size:.68rem;font-weight:850;cursor:pointer}.ll-identify-bay{border-color:color-mix(in srgb,var(--warn) 40%,transparent);background:color-mix(in srgb,var(--warn) 22%,transparent);color:var(--warn)}.ll-ack-backup:disabled,.ll-identify-bay:disabled{opacity:.55;cursor:default}.ll-action-row .ll-ack-ok{color:var(--good);font-size:.65rem;font-weight:900}@media(max-width:760px){.ll-action-row{display:block}.ll-action-buttons{justify-content:flex-start;margin-top:.55rem}}
`;
