...
- [Cargo Bay](CARGO_BAY.md) for recent Sonarr/Radarr imports, live queue state, current-file resolution, Pilot/Flight Engineer presentation, and evidence-backed independent backup status
