...
#define GPIO6_DIRECTION 0x90
#define GPIO6_OUTPUT    0x91
...
static void restore(void)
{
    if (runtime_access && value_changed) {
        ...
        fprintf(stderr,
                "\nRestored I91 to original value 0x%02X\n",
                original_value);
    }
}
...
int main(int argc, char **argv)
{
    ...
    printf("Direction I90: 0x%02X\n", direction);
    printf("Original I91:  0x%02X\n", original_value);
