        ...
        hangar_flight_check = run(
            [
                ...
                (
                    ...
                    "session_proof = run_credential_session_rehearsal(); "
                    "assert session_proof['measurements']['unsafe_holds'] == 6; "
                    "assert session_proof['measurements']['credential_occurrences_in_evidence'] == 0; "
                    "assert session_proof['measurements']['mutating_method_calls'] == 0; "
                    "session = next(item for item in registry['experiments'] "
