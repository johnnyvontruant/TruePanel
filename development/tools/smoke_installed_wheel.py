        ...
        hangar_flight_check = run(
            [
                ...
                (
                    ...
                    "consequences = next(item for item in registry['experiments'] "
                    "if item['id'] == 'TP-EXP-0020'); "
                    "assert consequences['state'] == 'COMPLETED'; "
                    "stable_identity = next(item for item in registry['experiments'] "
                    "if item['id'] == 'TP-EXP-0021'); "
                    "assert stable_identity['state'] == 'COMPLETED'; "
                    "identity_coverage = next(item for item in registry['experiments'] "
                    "if item['id'] == 'TP-EXP-0029'); "
                    "assert identity_coverage['state'] == 'COMPLETED'; "
                    "from truepanel.holodeck.aegis_identity_coverage import "
                    "run_identity_coverage_rehearsal; "
                    "identity_proof = run_identity_coverage_rehearsal(); "
                    "assert identity_proof['result'] == 'PASS'; "
                    "assert identity_proof['measurements']['false_outcomes'] == 0; "
                    "appraisal = next(item for item in registry['experiments'] "
                    "if item['id'] == 'TP-EXP-0030'); "
                    "assert appraisal['state'] == 'COMPLETED'; "
                    "from truepanel.holodeck.aegis_coverage_appraisal import "
                    "run_coverage_appraisal_rehearsal; "
                    "appraisal_proof = run_coverage_appraisal_rehearsal(); "
                    "assert appraisal_proof['result'] == 'PASS'; "
                    "assert appraisal_proof['measurements']['false_ready'] == 0; "
                    "assert appraisal_proof['measurements']['candidate_acceptances'] == 0; "
                    "identity_review = next(item for item in registry['experiments'] "
                    "if item['id'] == 'TP-EXP-0031'); "
                    "assert identity_review['state'] == 'COMPLETED'; "
                    "from truepanel.holodeck.aegis_identity_review import "
                    "run_identity_review_rehearsal; "
                    "review_proof = run_identity_review_rehearsal(); "
                    "assert review_proof['result'] == 'PASS'; "
                    "assert review_proof['measurements']['false_eligible'] == 0; "
                    "assert review_proof['measurements']['candidate_acceptances'] == 0; "
                    "assert review_proof['measurements']['successor_envelopes_created'] == 0; "
                    "coverage_envelope = next(item for item in registry['experiments'] "
                    "if item['id'] == 'TP-EXP-0032'); "
                    "assert coverage_envelope['state'] == 'COMPLETED'; "
                    "from truepanel.holodeck.aegis_coverage_envelope import "
                    "run_coverage_envelope_rehearsal; "
                    "envelope_proof = run_coverage_envelope_rehearsal(); "
                    "assert envelope_proof['result'] == 'PASS'; "
                    "assert envelope_proof['measurements']['false_ready'] == 0; "
                    "assert envelope_proof['measurements']['envelopes_accepted'] == 0; "
                    "assert envelope_proof['measurements']['envelopes_installed'] == 0; "
                    "envelope_review = next(item for item in registry['experiments'] "
                    "if item['id'] == 'TP-EXP-0033'); "
                    "assert envelope_review['state'] == 'COMPLETED'; "
                    "from truepanel.holodeck.aegis_envelope_review import "
                    "run_envelope_review_rehearsal; "
                    "envelope_review_proof = run_envelope_review_rehearsal(); "
                    "assert envelope_review_proof['result'] == 'PASS'; "
                    "assert envelope_review_proof['measurements']['false_eligible'] == 0; "
                    "assert envelope_review_proof['measurements']['envelopes_accepted'] == 0; "
                    "assert envelope_review_proof['measurements']['envelopes_installed'] == 0; "
